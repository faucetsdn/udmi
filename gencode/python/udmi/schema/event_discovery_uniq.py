"""Generated class for event_discovery_uniq.json"""
from .entry import Entry
from .ancillary_properties import AncillaryProperties


class UniqEnumerationEvent:
  ...
  def map_from(source):
    ...
    result = {}
    for key in source:
      result[key] = UniqEnumerationEvent.from_dict(source[key])
    return result
