...
public class FileMetadataGatewayJson {
    ...
    public String toString() {
        ...
        sb.append(FileMetadataGatewayJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("gatewayId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileMetadataGatewayJson) == false) {
            return false;
        }
        FileMetadataGatewayJson rhs = ((FileMetadataGatewayJson) other);
