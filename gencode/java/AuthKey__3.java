...
public class AuthKey__3 {
    ...
    public String toString() {
        ...
        sb.append(AuthKey__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AuthKey__3) == false) {
            return false;
        }
        AuthKey__3 rhs = ((AuthKey__3) other);
