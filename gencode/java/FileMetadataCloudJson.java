...
public class FileMetadataCloudJson {
    ...
    private FileMetadataCloudJson.AuthType authType;
     ...
     */
    @JsonProperty("auth_type")
    public FileMetadataCloudJson.AuthType getAuthType() {
        return authType;
    }
     ...
     */
    @JsonProperty("auth_type")
    public void setAuthType(FileMetadataCloudJson.AuthType authType) {
    ...
    public String toString() {
        ...
        sb.append(FileMetadataCloudJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("authType");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileMetadataCloudJson) == false) {
            return false;
        }
        FileMetadataCloudJson rhs = ((FileMetadataCloudJson) other);
    ...
    public enum AuthType {
        ...
        private final static Map<String, FileMetadataCloudJson.AuthType> CONSTANTS = new HashMap<String, FileMetadataCloudJson.AuthType>();

        static {
            for (FileMetadataCloudJson.AuthType c: values()) {
        ...
        @JsonCreator
        public static FileMetadataCloudJson.AuthType fromValue(String value) {
            FileMetadataCloudJson.AuthType constant = CONSTANTS.get(value);
            if (constant == null) {
