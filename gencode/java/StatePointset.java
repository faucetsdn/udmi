...
public class StatePointset {
    ...
    public String toString() {
        ...
        sb.append(StatePointset.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StatePointset) == false) {
            return false;
        }
        StatePointset rhs = ((StatePointset) other);
