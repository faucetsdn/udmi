...
public class FileMetadataSystemJson {
    ...
    private PhysicalTag physicalTag;
    @JsonProperty("aux")
    private Aux aux;
     ...
     */
    @JsonProperty("physical_tag")
    public PhysicalTag getPhysicalTag() {
        return physicalTag;
    }
     ...
     */
    @JsonProperty("physical_tag")
    public void setPhysicalTag(PhysicalTag physicalTag) {
    ...
    public String toString() {
        ...
        sb.append(FileMetadataSystemJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("location");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileMetadataSystemJson) == false) {
            return false;
        }
        FileMetadataSystemJson rhs = ((FileMetadataSystemJson) other);
