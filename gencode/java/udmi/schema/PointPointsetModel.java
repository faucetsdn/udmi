...
public class PointPointsetModel {
     ...
     * 
     */
    @JsonProperty("stale_threshold_sec")
    @JsonPropertyDescription("Represents the limit in seconds that a point can be stagnant/unchanged for")
    public Integer stale_threshold_sec;
    /**
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.stale_threshold_sec == null)? 0 :this.stale_threshold_sec.hashCode()));
