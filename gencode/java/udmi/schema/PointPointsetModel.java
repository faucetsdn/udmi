...
public class PointPointsetModel {
    ...
    /**
     * Complete resolved URL of this point as determined by the gateway and ref blocks
     * 
     */
    @JsonProperty("url")
    @JsonPropertyDescription("Complete resolved URL of this point as determined by the gateway and ref blocks")
    ...
    public BuildingTranslation translation;
