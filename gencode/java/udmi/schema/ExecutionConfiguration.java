...
public class ExecutionConfiguration {
    ...
    /**
     * Target IoT access provider override for reflector sessions
     * 
     */
    @JsonProperty("target_provider")
    @JsonPropertyDescription("Target IoT access provider override for reflector sessions")
    public String target_provider;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.target_provider == null)? 0 :this.target_provider.hashCode()));
