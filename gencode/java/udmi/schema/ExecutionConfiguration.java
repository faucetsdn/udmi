...
public class ExecutionConfiguration {
    ...
    @JsonProperty("feature_stage")
    public String feature_stage;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.feature_stage == null)? 0 :this.feature_stage.hashCode()));
