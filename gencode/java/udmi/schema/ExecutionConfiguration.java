...
public class ExecutionConfiguration {
    ...
    public ExecutionConfiguration.Iot_provider iot_provider;
    ...
    @Generated("jsonschema2pojo")
    public enum Iot_provider {

        GCP_NATIVE("gcp_native"),
        GCP("gcp"),
        CLEARBLADE("clearblade");
        private final String value;
        private final static Map<String, ExecutionConfiguration.Iot_provider> CONSTANTS = new HashMap<String, ExecutionConfiguration.Iot_provider>();

        static {
            for (ExecutionConfiguration.Iot_provider c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        Iot_provider(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static ExecutionConfiguration.Iot_provider fromValue(String value) {
            ExecutionConfiguration.Iot_provider constant = CONSTANTS.get(value);
            if (constant == null) {
