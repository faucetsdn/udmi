...
public class ExecutionConfiguration {
    ...
    @JsonProperty("message_feed")
    public String message_feed;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.message_feed == null)? 0 :this.message_feed.hashCode()));
