...
public class ExecutionConfiguration {
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.working_dir == null)? 0 :this.working_dir.hashCode()));
