...
public class ExecutionConfiguration {
     ...
     * 
     */
    @JsonProperty("mapping_service_configuration")
    @JsonPropertyDescription("Mapping Service Configuration")
    public MappingServiceConfig mapping_service_configuration;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.mapping_service_configuration == null)? 0 :this.mapping_service_configuration.hashCode()));
