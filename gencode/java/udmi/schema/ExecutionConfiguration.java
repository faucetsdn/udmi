...
public class ExecutionConfiguration {
    ...
    public ExecutionConfiguration.IotProvider iot_provider;
    ...
    public enum IotProvider {
        ...
        static {
            for (ExecutionConfiguration.IotProvider c: values()) {
        ...
        @JsonCreator
        public static ExecutionConfiguration.IotProvider fromValue(String value) {
            ExecutionConfiguration.IotProvider constant = CONSTANTS.get(value);
            if (constant == null) {
