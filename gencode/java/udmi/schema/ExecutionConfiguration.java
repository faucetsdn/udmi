...
public class ExecutionConfiguration {
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.stability == null)? 0 :this.stability.hashCode()));
