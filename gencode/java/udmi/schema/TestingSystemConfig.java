...
public class TestingSystemConfig {
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.transaction_id == rhs.transaction_id)||((this.transaction_id!= null)&&this.transaction_id.equals(rhs.transaction_id)))&&((this.endpoint_type == rhs.endpoint_type)||((this.endpoint_type!= null)&&this.endpoint_type.equals(rhs.endpoint_type))))&&((this.sequence_name == rhs.sequence_name)||((this.sequence_name!= null)&&this.sequence_name.equals(rhs.sequence_name))));
    }
