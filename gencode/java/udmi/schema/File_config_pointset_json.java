...
public class File_config_pointset_json {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof File_config_pointset_json) == false) {
            return false;
        }
        File_config_pointset_json rhs = ((File_config_pointset_json) other);
