...
public class PubberOptions {
     ...
     * 
     */
    @JsonProperty("hardwareIncompatible")
    @JsonPropertyDescription("If true, the pubber will simulate a physical hardware mismatch during OTA update.")
     ...
     * 
     */
    @JsonProperty("softwareDependencyMismatch")
    @JsonPropertyDescription("If true, the pubber will simulate a temporal software dependency mismatch during OTA update.")
    public Boolean softwareDependencyMismatch;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.softwareDependencyMismatch == null)? 0 :this.softwareDependencyMismatch.hashCode()));
        ...
        result = ((result* 31)+((this.hardwareIncompatible == null)? 0 :this.hardwareIncompatible.hashCode()));
