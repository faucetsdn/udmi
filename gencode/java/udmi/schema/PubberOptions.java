...
public class PubberOptions {
    ...
    @JsonProperty("redurectRegustry")
    public String redurectRegustry;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.redurectRegustry == null)? 0 :this.redurectRegustry.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.noHardware == rhs.noHardware)||((this.noHardware!= null)&&this.noHardware.equals(rhs.noHardware)))&&((this.extraField == rhs.extraField)||((this.extraField!= null)&&this.extraField.equals(rhs.extraField))))&&((this.redurectRegustry == rhs.redurectRegustry)||((this.redurectRegustry!= null)&&this.redurectRegustry.equals(rhs.redurectRegustry))))&&((this.missingPoint == rhs.missingPoint)||((this.missingPoint!= null)&&this.missingPoint.equals(rhs.missingPoint))))&&((this.noConfigAck == rhs.noConfigAck)||((this.noConfigAck!= null)&&this.noConfigAck.equals(rhs.noConfigAck))))&&((this.extraPoint == rhs.extraPoint)||((this.extraPoint!= null)&&this.extraPoint.equals(rhs.extraPoint))));
    }
