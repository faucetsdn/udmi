...
public class PubberOptions {
    ...
    @JsonProperty("badTimestamp")
    public Boolean badTimestamp;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.badTimestamp == null)? 0 :this.badTimestamp.hashCode()));
