...
public class PubberOptions {
    ...
    @JsonProperty("persistStore")
    public Boolean persistStore;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.persistStore == null)? 0 :this.persistStore.hashCode()));
