...
public class File_metadata_system_json {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof File_metadata_system_json) == false) {
            return false;
        }
        File_metadata_system_json rhs = ((File_metadata_system_json) other);
