...
public class SystemModel {
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.adjuct == null)? 0 :this.adjuct.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.software == rhs.software)||((this.software!= null)&&this.software.equals(rhs.software)))&&((this.adjuct == rhs.adjuct)||((this.adjuct!= null)&&this.adjuct.equals(rhs.adjuct))))&&((this.min_loglevel == rhs.min_loglevel)||((this.min_loglevel!= null)&&this.min_loglevel.equals(rhs.min_loglevel))))&&((this.location == rhs.location)||((this.location!= null)&&this.location.equals(rhs.location))))&&((this.physical_tag == rhs.physical_tag)||((this.physical_tag!= null)&&this.physical_tag.equals(rhs.physical_tag))))&&((this.hardware == rhs.hardware)||((this.hardware!= null)&&this.hardware.equals(rhs.hardware))));
    }
