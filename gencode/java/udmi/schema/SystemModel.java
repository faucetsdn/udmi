...
public class SystemModel {
    ...
    @JsonProperty("testing_test")
    public Integer testing_test = 3;
    /**
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.testing_test == null)? 0 :this.testing_test.hashCode()));
