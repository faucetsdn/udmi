...
public class File_metadata_gateway_json {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof File_metadata_gateway_json) == false) {
            return false;
        }
        File_metadata_gateway_json rhs = ((File_metadata_gateway_json) other);
