...
public class FamilyLocalnetModel {
    ...
    /**
     * The subnet within the gateway device to use for this network
     *
     */
    @JsonProperty("subnet_id")
    @JsonPropertyDescription("The subnet within the gateway device to use for this network")
    public java.lang.String subnet_id;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.subnet_id == null)? 0 :this.subnet_id.hashCode()));
