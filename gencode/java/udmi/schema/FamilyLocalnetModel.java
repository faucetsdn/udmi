...
public class FamilyLocalnetModel {
    ...
    public java.lang.String network_id;

    @Override
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.network_id == null)? 0 :this.network_id.hashCode()));
