...
public class FamilyLocalnetModel {
    ...
    /**
     * The subsystem within the gateway device to use for this network
     *
     */
    @JsonProperty("subsystem_id")
    @JsonPropertyDescription("The subsystem within the gateway device to use for this network")
    public java.lang.String subsystem_id;
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.subsystem_id == null)? 0 :this.subsystem_id.hashCode()));
