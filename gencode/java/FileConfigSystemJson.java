...
public class FileConfigSystemJson {
    ...
    public String toString() {
        ...
        sb.append(FileConfigSystemJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileConfigSystemJson) == false) {
            return false;
        }
        FileConfigSystemJson rhs = ((FileConfigSystemJson) other);
