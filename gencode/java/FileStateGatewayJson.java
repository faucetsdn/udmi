...
public class FileStateGatewayJson {
    ...
    public String toString() {
        ...
        sb.append(FileStateGatewayJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("errorIds");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileStateGatewayJson) == false) {
            return false;
        }
        FileStateGatewayJson rhs = ((FileStateGatewayJson) other);
