...
public class FileConfigPointsetJson {
    ...
    public String toString() {
        ...
        sb.append(FileConfigPointsetJson.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("stateEtag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileConfigPointsetJson) == false) {
            return false;
        }
        FileConfigPointsetJson rhs = ((FileConfigPointsetJson) other);
