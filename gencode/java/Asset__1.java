...
public class Asset__1 {
    ...
    public String toString() {
        ...
        sb.append(Asset__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Asset__1) == false) {
            return false;
        }
        Asset__1 rhs = ((Asset__1) other);
