...
public class StateSystem {
    ...
    @JsonProperty("auth_key")
    public AuthKey__3 getAuthKey() {
        return authKey;
    }

    @JsonProperty("auth_key")
    public void setAuthKey(AuthKey__3 authKey) {
     ...
     */
    @JsonProperty("firmware")
    public Firmware__1 getFirmware() {
        return firmware;
    }
     ...
     */
    @JsonProperty("firmware")
    public void setFirmware(Firmware__1 firmware) {
    ...
    @JsonProperty("statuses")
    public Statuses__1 getStatuses() {
        return statuses;
    }

    @JsonProperty("statuses")
    public void setStatuses(Statuses__1 statuses) {
    ...
    public String toString() {
        ...
        sb.append(StateSystem.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("makeModel");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StateSystem) == false) {
            return false;
        }
        StateSystem rhs = ((StateSystem) other);
