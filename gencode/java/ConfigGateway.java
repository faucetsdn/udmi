...
public class ConfigGateway {
    ...
    public String toString() {
        ...
        sb.append(ConfigGateway.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("proxyIds");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConfigGateway) == false) {
            return false;
        }
        ConfigGateway rhs = ((ConfigGateway) other);
