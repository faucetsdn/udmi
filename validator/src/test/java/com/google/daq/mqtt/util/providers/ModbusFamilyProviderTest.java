...
public class ModbusFamilyProviderTest {
  ...
  public static final Set<String> GOOD_REFERENCES = ImmutableSet.of(
      "modbus://host:502/1/3/40001",
      "modbus://network@host:502/1/3/40001/10",
      "modbus://network@host/1/3/40001/10?int16",
      "modbus://host/1/3/40001?int16",
      "modbus://host/1/3/40001",
      "modbus://[2001:db8::1]:502/1/3/40001",
      "modbus://1/i64/1/2/1/0", // misc/bambi/metadata.json (RTU)
      "modbus://1/holding_register/2_byte_signed/0" // docs/specs/modbus.md (RTU)
  );

  public static final Set<String> BAD_REFERENCES = ImmutableSet.of(
      "modbus://host:502/1/3",
      "modbus://host:502/1/3/40001/10/extra",
      "modbus://host:65536/1/3/40001", // bad port
      "modbus://@host/1/3/40001", // empty network
      "bacnet://host/1/3/40001" // wrong family
  );
