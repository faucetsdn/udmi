...
## scan_depth_system+vendor (ALPHA)

Check results of a single scan with system depth
...
1. Update config before scheduled scan active
    * Add `discovery.families.vendor` = { "generation": `family generation`, "depth": `system`, "scan_duration_sec": `10` }
