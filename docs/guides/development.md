...
1.  Setup up a GCP Project and IoT Core Registry. The 
    [cloud setup](../tools/cloud/cloud_setup.md) and [dashboard setup](dashboard.md) documents 
...
2.  Set up the [sequence tests](../tools/applications/sequencer.md). The public key used for the
