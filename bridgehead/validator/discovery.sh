...
bin/mapper $site_path $project_spec $discoveryNodeIp provision
bin/mapper $site_path $project_spec $discoveryNodeIp discover vendor
...
bin/mapper $site_path $project_spec $discoveryNodeIp map vendor
bin/mapper $site_path $project_spec $discoveryNodeIp discover