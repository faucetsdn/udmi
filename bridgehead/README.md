...
- Run pubber: `sudo docker exec externalPubber bin/pubber site_model/ //mqtt/<YOUR_HOST_IP> AHU-1 123456`
    ...
    *Note:* You can name the external pubber container anything, as long is it doesn't match of your other containers. I this case, it assumed you will still have the pubber container in the docker compose file, therefore the new container cannot also be called pubber.  
